...
const { parseHeaders } = require("../src/_11ty/apply-csp");
...
describe("check build output for a generic post", () => {
  describe("sample post", () => {
    const POST_PATH = "/content/posts/firstpost/";
    ...
    it("should have script elements", () => {
      ...
      expect(scripts).to.have.length(2); // NOTE: update this when adding more <script>
    ...
    it("should have a good CSP", () => {
      ...
      const headers = parseHeaders(readFileSync("./_site/_headers", { encoding: "utf-8" }));
      POST_PATH;
    ...
    it("should have accessible buttons", () => {
      ...
      for (let b of buttons) {
        expect((b.firstElementChild === null && b.textContent.trim()) || b.getAttribute("aria-label") != null).to.be
          .true;
      }
    });
